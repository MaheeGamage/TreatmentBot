...
const Treatments = {
    ...
    family: 'මෙම රෝග තත්වයට හේතුව ආරමය තත්වයක් බැවින් සම්පූර්ණයෙන්ම සුව කල නොහැක \n(සමේ වියලි බව ) අලිගැටපේර, කජු වැනි සවභාවිකව තෙල් සහිත ආහාර වර්ග වැඩිපුර භාවිතා කරන්න.\nකෝමාරිකා, හෝ අලිගැටපේර මද සම මත ආලේප කරන්න.\nදිනකට වතුර ලීටර් 1.5 වත් අවම වශයෙන් පානය කරන්න.\nස්වභාවික එලවලු හා පලතුරු දිනපතා ආහරයට එක කර ගන්න.',
    catarrh: 'සීතල ආහාර පාන වර්ග වලින් හැකිතාක් වලකින්න \nනෑමෙන් පසු හැකි ඉක්මනින් හිස කෙස් වේලාගන්න.',
    high_temp: '',
    dry_hair: 'පොල් තෙල්, එඬරු තෙල් හෝ තැඹිලි තෙල් හිසෙහි ගල්වන්න \nබිත්තර සුදු මදය , මී පැණි, අලිගැටපේර සමඟ කලවම්  කර හිaසෙහි අලේප කරන්න \nතේ කොල තෙල් හිසෙහි ආලේප කරන්න',
    unclean: '(සම සඳහා) සුදුසු පිරිසිදුකාරකයක් යොදා පිරිසිදුකරන්න.\nවෙනිවැල් කුඩු, මුං ඇට, නැවුම් එල කිරි සමඟ මුසු කර අඹරා ගත් ස්ක්‍රබ් එකක් ලෙස භාවිත කරන්න.',
    unbalance_food: 'දිනපතා සමබල ආහාර වේලක් ලබාගන්න \nදිනපතා ආහාර වේලට විටමින් හා ඛනිජ ලවණ අඩඟු ආහාර වර්ග එක් කරගන්න \nනවුeම් එලවලු සහ පලතුරු ආහාරයට ගන්න',
}
